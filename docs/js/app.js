App = {
    ...
    $.getJSON("TtdmTokenSale.json", function(ttdmTokenSale) {
      ...
      $.getJSON("TtdmToken.json", function(ttdmToken) {
        ...
        App.contracts.TtdmToken.deployed().then(function(ttdmToken) {
          console.log("Ttdm Token Address:", ttdmToken.address);
        });
  ...
  render: function() {
    ...
    App.contracts.TtdmTokenSale.deployed().then(function(instance) {
      ...
      // Load token contract
      App.contracts.TtdmToken.deployed().then(function(instance) {
        ttdmTokenInstance = instance;
        return ttdmTokenInstance.balanceOf(App.account);
      }).then(function(balance) {
        $('.ttdm-balance').html(balance.toNumber());
        App.loading = false;
        loader.hide();
        content.show();
      })
